...
const Activity = () => {
    ...
    const getPackages = async () => {
      try {
        const { data } = await axios.get(
          "https://api.trivi4.com/api/trivia/packages/proprietor",
          { headers }
        );
        if (viewMorePackages) {
          setPackages(data);
  ...
  useEffect(() => {
    const getTravels = async () => {
      try {
        const { data } = await axios.get(
          "https://api.trivi4.com/api/trivia/travels/proprietor",
          { headers }
        );
        if (viewMoreTravels) {
          setTravels(data);
  ...
  const handleCancelPackage = async (id) => {
    ...
    try {
      await axios.delete(
        `https://api.trivi4.com/api/trivia/packages/cancelation/${id}`,
        {
          headers,
        }
      );
  ...
  const handleCancelTravel = async (id) => {
    ...
    try {
      await axios.delete(
        `https://api.trivi4.com/api/trivia/travels/cancelation/${id}`,
        {
          headers,
        }
      );
                      ...
                      <div>
                        ...
                        <div className="">
                          <img
                            ...
                            src={`https://api.trivi4.com/api/trivia/packages/image/${userPackage.image}`}
                          />
                        </div>
