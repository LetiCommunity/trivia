...
const Notification = () => {
    ...
    const getRequests = async () => {
      try {
        const { data } = await axios.get(
          "https://api.trivi4.com/api/trivia/packages/filterByRequest",
          { headers }
        );
        if (viewMoreRequests) {
          setRequests(data);
  ...
  useEffect(() => {
    const getAcceptedRequests = async () => {
      try {
        const { data } = await axios.get(
          "https://api.trivi4.com/api/trivia/packages/filterByAcceptedRequest",
          { headers }
        );
  ...
  useEffect(() => {
    const getSuggestions = async () => {
      try {
        const { data } = await axios.get(
          "https://api.trivi4.com/api/trivia/packages/filterByMatch",
          { headers }
        );
  ...
  const handleConfirmation = async (id) => {
    ...
    try {
      await axios.get(
        `https://api.trivi4.com/api/trivia/packages/requests/confirmation/${id}`,
        { headers }
      );
      togglePackageDetails();
      setLoading(false);
  ...
  const handleAcceptance = async (id) => {
    ...
    try {
      await axios.get(
        `https://api.trivi4.com/api/trivia/packages/suggestions/confirmation/${id}`,
        { headers }
      );
      togglePackageDetails();
      setLoading(false);
  ...
  const handleRejection = async (id) => {
    ...
    try {
      await axios.get(
        `https://api.trivi4.com/api/trivia/packages/requests/rejection/${id}`,
        {
          headers,
        }
      );
                      ...
                      <div>
                        <div>
                          ...
                          <img
                            ...
                            alt="paquete"
                            src={`https://api.trivi4.com/api/trivia/packages/image/${userSuggestions.image}`}
                          />
                        </div>
                        <div className="pt-3">
                          <Row>
                      ...
                      <div>
                        <div>
                          ...
                          <img
                            className="package-image"
                            alt="paquete"
                            src={`https://api.trivi4.com/api/trivia/packages/image/${userRequest.image}`}
                          />
                        </div>
                        <div className="pt-3">
                          <Row>
                      ...
                      <div>
                        <div>
                          ...
                          <img
                            className="package-image"
                            alt="paquete"
                            src={`https://api.trivi4.com/api/trivia/packages/image/${userAcceptedRequest.image}`}
                          />
                          <p>
